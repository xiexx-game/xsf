...
//MESSAGE_BEGIN
		...
		NEW_MESSAGE(Cc_C_Handshake, xsf_pbid::CMSGID::Cc_C_Handshake)
		NEW_MESSAGE(C_Cc_Handshake, xsf_pbid::CMSGID::C_Cc_Handshake)
		NEW_MESSAGE(Cc_C_Heartbeat, xsf_pbid::CMSGID::Cc_C_Heartbeat)
		NEW_MESSAGE(Cc_C_ServerInfo, xsf_pbid::CMSGID::Cc_C_ServerInfo)
		NEW_MESSAGE(C_Cc_ServerInfo, xsf_pbid::CMSGID::C_Cc_ServerInfo)
		NEW_MESSAGE(Cc_C_ServerLost, xsf_pbid::CMSGID::Cc_C_ServerLost)
		NEW_MESSAGE(C_Cc_ServerLost, xsf_pbid::CMSGID::C_Cc_ServerLost)
		NEW_MESSAGE(Cc_C_ServerOk, xsf_pbid::CMSGID::Cc_C_ServerOk)
		NEW_MESSAGE(C_Cc_ServerOk, xsf_pbid::CMSGID::C_Cc_ServerOk)
		NEW_MESSAGE(C_Cc_Stop, xsf_pbid::CMSGID::C_Cc_Stop)
		NEW_MESSAGE(Gt_GtA_Handshake, xsf_pbid::CMSGID::Gt_GtA_Handshake)
		NEW_MESSAGE(GtA_Gt_Handshake, xsf_pbid::CMSGID::GtA_Gt_Handshake)
		NEW_MESSAGE(Gt_GtA_Heartbeat, xsf_pbid::CMSGID::Gt_GtA_Heartbeat)
		NEW_MESSAGE(Gt_GtA_ClientClose, xsf_pbid::CMSGID::Gt_GtA_ClientClose)
		NEW_MESSAGE(GtA_Gt_ClientDisconnect, xsf_pbid::CMSGID::GtA_Gt_ClientDisconnect)
		NEW_MESSAGE(GtA_Gt_ClientMessage, xsf_pbid::CMSGID::GtA_Gt_ClientMessage)
		NEW_MESSAGE(GtA_Gt_Broadcast, xsf_pbid::CMSGID::GtA_Gt_Broadcast)
		NEW_MESSAGE(GtA_Gt_SetServerId, xsf_pbid::CMSGID::GtA_Gt_SetServerId)
//MESSAGE_END
