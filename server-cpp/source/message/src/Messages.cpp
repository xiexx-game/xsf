...
//MESSAGE_BEGIN
	...
	MESSAGE_FUNCTIONS(Dbc_Db_Handshake)
	MESSAGE_FUNCTIONS(Db_Dbc_Handshake)
	MESSAGE_FUNCTIONS(Dbc_Db_Heartbeat)
	MESSAGE_FUNCTIONS(Dbc_Db_Request)
	MESSAGE_FUNCTIONS(Db_Dbc_Response)
	MESSAGE_FUNCTIONS(Hc_H_Handshake)
	MESSAGE_FUNCTIONS(H_Hc_Handshake)
	MESSAGE_FUNCTIONS(Hc_H_Heartbeat)
	MESSAGE_FUNCTIONS(G_G_HubTest)
//MESSAGE_END
}
