...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public bool __Gen_Delegate_Imp0(UnityEngine.GameObject p0)
		{
		...
		public bool __Gen_Delegate_Imp1(uint p0, uint p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(OnUILoadCall))
			{
			    return new OnUILoadCall(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(OnLuaEventFunc))
			{
			    return new OnLuaEventFunc(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(OnClickCallback))
			{
			    return new OnClickCallback(__Gen_Delegate_Imp2);
			}
